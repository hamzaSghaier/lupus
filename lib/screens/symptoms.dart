...
class _SymptomsScreenState extends State<SymptomsScreen> {
  ...
  @override
  void initState() {
    FileService.getlatestSymptomes().then((value) {
      if (value != null &&
          !isEditing &&
          areDatesOnSameDay(value.createdAt, DateTime.now())) {
        setState(() {
          loading = false;
          latestSymp = value;
          _selectedValueHumeur = value.humeur.value;
          _selectedAutonomieValue = value.autonomie.value;
          _selectedSomeilValue = value.sommeil.value;
          _selectedFatigueValue = value.fatigue.value.toDouble();
          _selectedArthralgieValue = value.arthralgies.value.toDouble();
          ...
          noteController.text = value.remarque.value;
        });
      }
      setState(() {
        loading = false;
                    ...
                    : Column(
                        ...
                        children: [
                          ...
                          AbsorbPointer(
                            absorbing: (!isEditing &&
                                areDatesOnSameDay(
                                    latestSymp?.createdAt, DateTime.now())),
                            child: Column(
                              children: [
                                //===== FATIGUE =====
                                const TitleOfSlider(
                                ...
                                Slider(
                                  ...
                                  max: 10,
                                  divisions: 10,
                                  label: _selectedArthralgieValue
                                      .round()
                                      .toString(),
                                ),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              (!areDatesOnSameDay(latestSymp?.createdAt,
                                          DateTime.now()) ||
                                      isEditing)
                                  ? ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        var arthralgies = SymptomeData(
                                          value:
                                              _selectedArthralgieValue.round(),
                                          date: now,
                                        );
                                        ...
                                        if (isEditing) {
                                          ...
                                          await FileService
                                              .updatelatestSymptomes(symptome);
                                          await FileService
                                              .updatelatestSymptomes(symptome);
                                          setState(() {
                                            saved = true;
